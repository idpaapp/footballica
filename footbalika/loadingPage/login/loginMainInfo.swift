...
public class loginMainInfo {
    ...
    public struct response : Decodable {
       let id : String?
       let username : String?
       let one_signal_id : String?
       let pushe_id : String?
       let email : String?
       let email_connected : String?
       let email_connected_date : String?
       let password : String?
       let ref_id : String?
       let cups : String?
